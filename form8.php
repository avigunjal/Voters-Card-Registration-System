...
<font color="blue" size=6 face="Liberation Sans Narrow">Application For Correction To Particulars Entered In Electoral Roll </font>
</marquee>
<br><br>
*Fill details in capitals.
may left unnecessary fields
 <form action="http://localhost/voters/php/form8.php" method="POST" name="form1" autocomplete="on">
...
<td >0.</td>
    <td>LoginID:</td><td><input style="color:red;" id="loginid" type="text" name="login_id"  maxlength="30" value="<?php session_start();echo $_SESSION['login_id']?>" onblur="window.alert('Do not change your login_id')" ></td></tr>
<tr>
<td >1.</td>
<td >Full Name :</td>
<td>
...
<input type="submit" name="submit" value="submit"  onclick="idcard()"> <input type="reset" style="background:#ff88cc;
        border: none;
