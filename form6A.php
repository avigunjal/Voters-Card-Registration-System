...
<font color="blue" size=6 face="Liberation Sans Narrow">Online Electoral Roll Form No-6A</font>
</marquee>
<br><br>
...
<center><table>
<tr>
    <td>LoginID:</td><td><input style="color:red;" id="loginid" type="text" name="login_id"
...
State:</td><td><SELECT id=state name="state" ><OPTION selected value="Select One">Select One</OPTION>
							...
							<OPTION value="West Bengal">West Bengal</OPTION></td></SELECT>
</td></tr>
<tr>
