...
input[type="text"],[type="radio"]{padding:10px;margin:6px; border-radius:10px;border:2px black groove; width: 200px;font-size:15px;
	...
	font-weight:500;color:blue;text-transform:uppercase;font-family: Verdana, Arial, Helvetica, sans-serif;}
     body{margin:5px 30px; background:gray;}
      table{box-shadow: 0px 0px 50px rgba(4, 129, 177, 0.5);border:1px solid black; font-family:Linux Libertine Display;}
 th{text-align:center;}
	
    /*td{color:green;padding:8px 20px;margin:auto;text-align:left;font-weight:500;font-family:Linux Libertine Display; }*/
    table,th,td{border-bottom:1px inset green; border-radius:10px;padding:05x;margin-top:5px;margin:0px;background:#f5fcfe;}
...
<script src="http://localhost/voters/script/Form19.js"></script>
</head>
...
<font color="blue" size=6 face="Liberation Sans Narrow">Claim for inclusion of name in the electoral roll for a teachers' constituency </font>
</marquee>
<br><br>
*Fill details in capitals.
may left blank unnecessary fields..

<form action="http://localhost/voters/php/Form19.php" name="Form19" onsubmit="return Validate()" method="POST">
...
<fieldset><legend><b><h3><blink><font color=pink>Part B:--Teaching Details</font></blink></h3></b></legend>
<table border=5 bordercolor=#696999>
<tr>
<td ><b>No.</td>
<td ><b>Name of Educational Institution</td>
<td ><b>From (Date)</td>
<td ><b>To (Date)</td>
<td ><b>Period</td>
</tr>
...
<tr>
<td >1.</td>
<td ><input type=text name=Institute1 size=40 ></td>

<td >
<table>
<tr>
<td ><b>Day</td><td ><b>Month</td><td ><b>Year</td></tr>

<tr>
<td ><select name=FromDay1>
<option value=0 selected>Select
<option value="1">01
<option value="2">02
<option value="3">03
...
<td ><input type=text name=Period1 size=9></td>
</tr>

<tr>
<td >2.</td>
<td ><input type=text name=Institute2 size=40 ></td>
<td >
<table>
<tr>
<td ><b>Day</td><td ><b>Month</td><td ><b>Year</td></tr>
...
<td ><input type=text name=Period2 size=9></td>

</tr>

<tr>
<td >3.</td>
<td ><input type=text name=Institute3 size=40 ></td>
<td >
<table>
<tr>
<td ><b>Day</td><td ><b>Month</td><td ><b>Year</td></tr>
...
<td ><input type=text name=Period3 size=9></td>
</tr>

<tr>
<td >4.</td>
<td ><input type=text name=Institute4 size=40 ></td>
<td >
<table>
<tr>
<td ><b>Day</td><td ><b>Month</td><td ><b>Year</td></tr>
...
<td ><input type=text name=Period4 size=9></td>
</td></tr>
