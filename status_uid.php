...
<body style="background:-moz-linear-gradient(gray,white);margin:0px;">
<div id="container"  style="background:-moz-linear-gradient(red,white);">
<header> 
<div class="width">
<h1><a href="http://localhost/voters/admin_index.html"> 
...
<div class="first">
 <h5>Generate Report!!</h5>
    <form action="http://localhost/voters/php/statusreport.php" method="post">
  <div class="main">
    <table>
<tr><td>Enter Emp ID:</td>
<td><input type="text" name="empid" required></td></tr>
    </table>
   </div>
