...
<div class="first">
      <h5>Enquiry Section!!</h5>
    <form action="http://localhost/voters/php/enquiryconfirm.php" method="post">
  <div class="main">
    <table>
<td>Login_Id:</td>
<td><input style="color:red;" type="text" name="login_id" value="<?php session_start(); echo $_SESSION['login_id'];?>"
onblur="window.alert('Do not change your Login_Id')" readonly="" /></td></tr>
