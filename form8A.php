...
#sdate,input{padding:5px;margin: 10px; border-radius:8px;border:1px black groove; width: 400px;font-weight:600;color:red;text-transform:capitalize;text-align:center;font-size:15px;}
	...
	input[type="text"]:focus{background:lightgray;color:black;}
...
if(a=="" || isNaN(a))
{
alert("Please Enter Valid Voter Id Card No");
form1.action="http://localhost/voters/php/form8Ainsert.php";
...
function part_check()
    {
var z=document.form1.partno.value;
if(isNaN(z))
{
...
<font color="blue" size=6 face="Liberation Sans Narrow">Application for transposition of entry in electoral roll </font>
</marquee>
<br><br>
*Fill details in capitals.
may left unnecessary fields
 <form action="http://localhost/voters/php/form8Ainsert.php" method="POST" name="form1" autocomplete="on">
...
<tr>
<td><input type=text name="fname" autofocus id="fname" onblur="fname_check()"></td>
<td><input type=text name="mname" id="mname" onblur="mname_check()"></td>
<td><input type=text name="lname" id="lname" onblur="lname_check()"></td>
</tr></table>
</td>
</tr>
...
<td ><input type=text name=F8PN id="eid" onblur="eid_check()"></td>
</tr>
...
<td >First name</td><td >Middel name</td><td >Last name</td></tr>
<tr>
<td><input type=text name="ffname" id="fname" onblur="fname_check()"></td>
<td><input type=text name="fmname" id="mname" onblur="mname_check()"></td>
<td><input type=text name="flname" id="lname" onblur="lname_check()"></td>
</tr></table></td>
</tr>
...
<tr>
<td>1.</td>
<td> Period of continuous residence at the above address </td>
<td>
<table>
<tr><td >Years</td><td>Months</td></tr>
<tr><td ><input type=text name=resyear size=5></td><td ><input type=text name=resmonth size=5></td></tr></table></td>
</tr>

<tr>
<td >2.</td>
<td >Part number to which the entry has to be transposed (if known)</td>
...
<td><input type=text name=Idno id="idno" onblur="idcard()"></td>
</tr>
